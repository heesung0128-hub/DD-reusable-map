...
export const RESTAURANTS_DATA: Restaurant[] = [
  {
    ...
    reviewCount: 142,
    ecoScore: 95,
    tags: ['#다회용기주문', '#국물전용보온용기', '#방배역맛집', '#교내반납가능'],
  ...
  },
  {
    ...
    reviewCount: 318,
    ecoScore: 98,
    tags: ['#동덕생단골', '#다회용기선택', '#국물떡볶이', '#간편반납'],
    bannerImage: 'https://images.unsplash.com/photo-1627042633145-b780d842ba45?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    reviewCount: 204,
    ecoScore: 99,
    tags: ['#초저탄소메뉴', '#에코포케', '#다회용보울제공', '#세척불필요반납'],
  ...
  },
  {
    ...
    reviewCount: 95,
    ecoScore: 90,
    tags: ['#양식다회용기', '#마늘빵증정', '#시험끝나고갈곳', '#보온유지'],
  ...
  },
  {
    ...
    reviewCount: 260,
    ecoScore: 100,
    tags: ['#다회용컵제공', '#비건베이커리', '#후문바로앞', '#동덕여고아지트'],
    bannerImage: 'https://images.unsplash.com/photo-1517701550927-30cf4ba1dba5?auto=format&fit=crop&w=800&q=80',
...
export const INITIAL_CERTIFICATION_POSTS: CertificationPost[] = [
  {
    ...
    containerType: '가게 대여 스테인리스 보온용기',
  ...
  },
  {
    ...
    containerType: '가게 제공 BPA-Free 밀폐 다회용기',
  ...
  },
  {
    ...
    containerType: '전문 살균 에코 다회용 샐러드 보울',
